...
------------- | ------------- | -------------
[**walletexchangeconnectconnectwallet**](APIKeysApi.md#walletexchangeconnectconnectwallet) | **POST** /v0/wallet/{exchange}/connect | Connect Wallet
...
import type { APIKeysApiWalletexchangeconnectconnectwalletRequest } from '';

const configuration = createConfiguration();
const apiInstance = new APIKeysApi(configuration);

const request: APIKeysApiWalletexchangeconnectconnectwalletRequest = {
  ...
  walletexchangeconnectconnectwalletRequest: {
...
const data = await apiInstance.walletexchangeconnectconnectwallet(request);
