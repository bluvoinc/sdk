...
export class PromiseOAuth2Api {
     ...
     */
    public oAuth2LinkWithHttpInfo(exchange: 'coinbase' | 'kraken', idem: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<OAuth2Link200Response>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.oAuth2LinkWithHttpInfo(exchange, idem, observableOptions);
        return result.toPromise();
    }
     ...
     * @param idem The idem provided by OTT or used to identify the workflow run. This is used to track the OAuth2 flow and can be used to subscribe to updates.
     */
    public oAuth2Link(exchange: 'coinbase' | 'kraken', idem: string, _options?: PromiseConfigurationOptions): Promise<OAuth2Link200Response> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.oAuth2Link(exchange, idem, observableOptions);
        return result.toPromise();
    }
