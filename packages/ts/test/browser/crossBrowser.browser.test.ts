...
describe('Cross-Browser Compatibility', () => {
  ...
  describe('Chrome/Chromium-specific behavior', () => {
    it('should handle OAuth flow in Chromium', async () => {
      ...
      if (!isChromium) {
        console.log('Skipping Chromium-specific test in', navigator.userAgent);
        return;
      }
  ...
  describe('Firefox-specific behavior', () => {
    it('should handle OAuth flow in Firefox', async () => {
      // Skip if not in Firefox
      const isFirefox = window.navigator.userAgent.toLowerCase().includes('firefox');

      if (!isFirefox) {
        console.log('Skipping Firefox-specific test in', navigator.userAgent);
        return;
      }
  ...
  describe('Safari/Webkit-specific behavior', () => {
    it('should handle OAuth flow in Safari', async () => {
      ...
      if (!isSafari) {
        console.log('Skipping Safari-specific test in', navigator.userAgent);
        return;
      }
